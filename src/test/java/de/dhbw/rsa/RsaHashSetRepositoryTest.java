...
@SpringBootTest
public class RsaHashSetRepositoryTest {

    @Autowired
    private RsaBloomFilterRepository rsaBloomFilterRepository;
    ...
    public void testUseModulusAsKeyRepresentation() throws Exception {
        ...
        final String keyRepresentation = rsaBloomFilterRepository.getKeyRepresentation(publicKeyStub);
